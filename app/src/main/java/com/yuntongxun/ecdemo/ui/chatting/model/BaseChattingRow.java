...
import com.yuntongxun.yxw.DoctorActivity;
import com.yuntongxun.yxw.MyActivity;
        ...
        if (baseHolder.getChattingAvatar() != null && detail != null) {
            baseHolder.getChattingAvatar().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ECMessage.Direction direction = detail.getDirection();
                    ECMessage.Direction receive = ECMessage.Direction.RECEIVE;
                    ECMessage.Direction send = ECMessage.Direction.SEND;
                    Intent intent = null;
