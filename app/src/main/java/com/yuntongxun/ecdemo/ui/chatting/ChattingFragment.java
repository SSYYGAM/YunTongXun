    ...
    private void initView() {
        ...
        sendTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.put("medicineId", "m123456");
                map.put("medicineUrl", "http://192.168.10.101:81/sftp//2017/3month/8day/]5VENNLV4%605%7B6_G0DU%7BB6RA.jpg");
                map.put("medicineName", "999感冒灵");
                map.put("medicineDiscountPrice", 24);
                map.put("medicineMarkPrice", 38);
                map.put("medicineTotal", 100);
                map.put("medicineNum", 3);
                map.put("medicineDescription", "我是药品说明");
                map.put("doctorId", "d123456");
                map.put("type", "ywkp");
...
//                sb.append(s);
//                Log.e("====", "===药品===" + sb.toString());
                sendCustomInfo("药物卡片", s);
            }
        });

        TextView sendShouFeiTv = (TextView) findViewById(R.id.sendShouFeiTv);
        sendShouFeiTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                map.put("chargePrice", 100);
                map.put("chargeTime", format);
                map.put("chargeDescription", "我是收费说明");
                map.put("doctorId", "d123456");
                map.put("type", "sfkp");
...
//                StringBuilder sb = new StringBuilder("json:");
//                sb.append(s);
//                Log.e("====", "===收费===" + sb.toString());
                sendCustomInfo("收费卡片", s);
            }
        });
    ...
    private void sendCustomInfo(String bodyStr, String json) {
        ...
        // 创建一个文本消息体，并添加到消息对象中
        msgBody = new ECTextMessageBody(bodyStr);
        msg.setBody(msgBody);


        msg.setUserData(json);
        Log.e("====", "===sendCustomInfo===" + json);
