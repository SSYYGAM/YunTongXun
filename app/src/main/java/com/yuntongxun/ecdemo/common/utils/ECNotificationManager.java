...
import com.yuntongxun.yxw.LoginActivity;
import com.yuntongxun.yxw.MainActivity;
...
public class ECNotificationManager {
    ...
    public final void showCustomNewMessageNotification(Context context , String pushContent ,String fromUserName ,String sessionId ,  int lastMsgType) {
        ...
        Log.e("====", "===showCustomNewMessageNotification===2222222222222222222");
//        Intent intent = new Intent(mContext, LauncherActivity.class);
    ...
    public final void showKickoffNotification(Context context , String kickofftext) {
        Log.e("====", "===showKickoffNotification==="+kickofftext);
        ...
        boolean isMainActivityShowing = false;
        if(taskInfoList != null && taskInfoList.size() > 0) {
            ComponentName cpn = taskInfoList.get(0).topActivity;
